  ...
  export class forMain {
    constructor(page: 'colleague-main' | 'coworker-main' | 'logged-main' | 'manage-main' | 'user-main', status: 'pending' | 'assigned' | 'resolved' | 'deleted' | 'everything') {
      ...
      function buildTickets(
        page: 'colleague-main' | 'coworker-main' | 'logged-main' | 'manage-main' | 'user-main',
        status: 'pending' | 'assigned' | 'resolved' | 'deleted' | 'everything'
      ) {
        ...
        switch (page) {
          ...
          case 'logged-main':
            ...
            for (let i = 0; i < ticketsTotal; i++) {
              ...
              let ticketStatus: String = ticketInfo.children[0].textContent;
              ...
              if (senderName === userName && ticketStatus.toLowerCase() === status) {
                $(ticketsMain).append(
                  `<article class="${status}" onClick="$('.active-ticket').removeClass('active-ticket'); $(this).addClass('active-ticket');">
          ...
          case 'manage-main':
            ...
            console.log(`${findDepartment(userName)}`);
            break;
          case 'user-main':
            break;
        }
